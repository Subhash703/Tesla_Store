        ...
        <header>
          <Header>
            <div className='wrapper'>
              <h1 className='title_h'>
                Front End <br /> Web Developer
                <span>
                  HTML5, CSS3, JS and ReactJS, React-Native | Back end in PHP &
                  MySQL. <br />
                </span>
                <div className='btn btn-success btn-block my-3'>
                  <a
                    style={{ color: '#fff' }}
                    href='https://scdev.netlify.app/'
                    target='_blank'
            ...
            <div className='main_image'>
              ...
              <div className='details'>
                ...
                <p>
                  ...
                  2nd Year , Lovely Professional University
                </p>
              </div>
            </div>
          </div>
